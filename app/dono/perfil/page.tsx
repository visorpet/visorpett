...
function MenuItem({ icon, label, badge, danger }: { icon: string, label: string, badge?: string, danger?: boolean }) {
  return (
      ...
      <section className="animate-slide-up space-y-6">
        <div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <MenuItem icon="inventory_2" label="Serviços e Preços" />
            <MenuItem icon="badge" label="Equipe e Tosadores" badge="3" />

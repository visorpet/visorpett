...
const adminNavItems = [
  ...
  { href: "/admin/suporte",    label: "Suporte",      icon: "headset_mic" },
];
...
export function SuperAdminSidebar() {
  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-64 bg-white border-r border-primary/10 flex-col hidden md:flex">
      {/* Logo */}
      ...
      <div className="p-4 border-t border-primary/5">
        <Link
          ...
          className={cn(
            "flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-gray-50 transition-colors",
            pathname === "/admin/configuracoes" && "bg-gray-50"
          )}
        >
